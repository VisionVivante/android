...
public class UrlController {
    ...
    private static String Custom_Security = "0987654321";//Custom Security code can be any random string Like your name or 1234
    private static String IP_ADDRESS = "http://boobur.com/";
