package com.booburbundle1.adforest.userAndSellers;
...
import com.booburbundle1.adforest.modelsList.sellersModel;
import com.booburbundle1.adforest.public_profile.FragmentPublic_Profile;
import com.booburbundle1.adforest.userAndSellers.adapter.ItemSellersListAdapter;
                        ...
                        if (responseObj.isSuccessful()) {
                            ...
                            if (response.getBoolean("success")) {
                                ...
                                if (response.getJSONObject("data").getJSONArray("authors").length() > 0) {
                                    ...
                                    itemSellersListAdapter.setOnItemClickListener(new ItemSellersListAdapter.sellersListClickListener() {
                                        @Override
