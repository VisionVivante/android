package com.booburbundle1.adforest.userAndSellers.adapter;
...
import com.booburbundle1.adforest.public_profile.social_icons;
    ...
    public void onBindViewHolder(ItemSellersListAdapter.CustomViewHolder customViewHolder, final int i) {
        ...
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                blockUserClickListener.onClick(feedItem);
            }
        };
